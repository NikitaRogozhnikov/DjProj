...
def results(request, question_id):
    question = get_object_or_404(Question, pk=question_id)
    return render(request, 'simpleapp/results.html', {'question': question})
...
def vote(request, question_id):
    ...
    try:
        ...
        return render(request, 'simpleapp/detail.html', {
            'question': question,
        ...
        return HttpResponseRedirect(reverse('simpleapp:results', args=(question.id,)))
